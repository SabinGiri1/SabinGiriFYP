...
const VetProfile = () => {
    ...
    const { vToken, profileData, setProfileData, getProfileData } = useContext(VetContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/vet/update-profile', updateData, { headers: { vToken } })
        ...
        <div>
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    {/* ----- Vet Info : name, degree, experience ----- */}
